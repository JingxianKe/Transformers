...
anno_path = '/Users/mac/Downloads/caltech-101/Annotations/Motorbikes_16/'
annonames = os.listdir(anno_path)

with open('motocycle.csv', 'w', newline='') as csvfile:
    ...
    for annoname in annonames:
        ...
        spamwriter.writerow([imgname] + [i] + [j] + [k] + [l] + ['motocycle'])
